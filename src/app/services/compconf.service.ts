...
public worksmss$ = new Subject<Worksms[]>();
  ...
  modifycompconfById(id: string, compconf: Compconf) {
    return new Promise((resolve, reject) => {
      this.http.put(API_URL_test+'compconf/'+ id, compconf).subscribe(
        (response) => {
          resolve(response);
        },
        (error) => {
  ...
  getcompconfById(id: string) {
    return new Promise((resolve, reject) => {
      this.http.get(API_URL_test+'compconf/' + id).subscribe(
        (response) => {
          resolve(response);
        },
        (error) => {
  ...
  deletecompconfById(id: string) {
    return new Promise((resolve, reject) => {
      this.http.delete(API_URL_test+'compconf/'+ id).subscribe(
        (response) => {
          resolve(response);
        },
        (error) => {
  ...
  deletecompconfs() {
    return new Promise((resolve, reject) => {
      this.http.delete(API_URL_test+'allcompconf/').subscribe(
        (response) => {
          resolve(response);
        },
        (error) => {
  ...
  modifyworgabById(id: string, Workgab: Workgab) {
    return new Promise((resolve, reject) => {
      this.http.put(API_URL_test+'workgab/'+ id, Workgab).subscribe(
        (response) => {
          resolve(response);
        },
        (error) => {
  ...
  getWorkgabs() {
    return new Promise((resolve, reject) => {
      this.http.get(API_URL_test+'allworkgab/').subscribe(
        (Workgabs: Workgab[]) => {
          if (Workgabs) {
  ...
  getworgabById(id: string) {
    return new Promise((resolve, reject) => {
      this.http.get(API_URL_test+'workgab/' + id).subscribe(
        (response) => {
          resolve(response);
        },
        (error) => {
  ...
  deleteworkgabById(id: string) {
    return new Promise((resolve, reject) => {
      this.http.delete(API_URL_test+'workgab/'+ id).subscribe(
        (response) => {
          resolve(response);
        },
        (error) => {
  ...
  deleteWorkgabs() {
    return new Promise((resolve, reject) => {
      this.http.delete(API_URL_test+'allworkgab/').subscribe(
        (response) => {
          resolve(response);
        },
        (error) => {
  ...
  modifyworkposById(id: string, Workpos: Workpos) {
    return new Promise((resolve, reject) => {
      this.http.put(API_URL_test+'workpos/'+ id, Workpos).subscribe(
        (response) => {
          resolve(response);
        },
        (error) => {
  ...
  getWorkposs() {
    return new Promise((resolve, reject) => {
      this.http.get(API_URL_test+'allworkpos/').subscribe(
        (Workposs: Workpos[]) => {
          if (Workposs) {
  ...
  getworkposById(id: string) {
    return new Promise((resolve, reject) => {
      this.http.get(API_URL_test+'workpos/' + id).subscribe(
        (response) => {
          resolve(response);
        },
        (error) => {
  ...
  deleteworkposById(id: string) {
    return new Promise((resolve, reject) => {
      this.http.delete(API_URL_test+'workpos/'+ id).subscribe(
        (response) => {
          resolve(response);
        },
        (error) => {
  ...
  deleteWorkposs() {
    return new Promise((resolve, reject) => {
      this.http.delete(API_URL_test+'allworkpos/').subscribe(
        (response) => {
          resolve(response);
        },
        (error) => {
  ...
  modifyworksmsById(id: string, Worksms: Worksms) {
    return new Promise((resolve, reject) => {
      this.http.put(API_URL_test+'worksms/'+ id, Worksms).subscribe(
        (response) => {
          resolve(response);
        },
        (error) => {
  ...
  getWorksmss() {
    return new Promise((resolve, reject) => {
      this.http.get(API_URL_test+'allworksms/').subscribe(
        (Worksmss: Worksms[]) => {
          if (Worksmss) {
  ...
  getworksmsById(id: string) {
    return new Promise((resolve, reject) => {
      this.http.get(API_URL_test+'worksms/' + id).subscribe(
        (response) => {
          resolve(response);
        },
        (error) => {
  ...
  deleteworksmsById(id: string) {
    return new Promise((resolve, reject) => {
      this.http.delete(API_URL_test+'worksms/'+ id).subscribe(
        (response) => {
          resolve(response);
        },
        (error) => {
  ...
  deleteWorksmss() {
    return new Promise((resolve, reject) => {
      this.http.delete(API_URL_test+'allworksms/').subscribe(
        (response) => {
          resolve(response);
        },
        (error) => {
